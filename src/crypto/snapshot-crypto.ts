 ...
 *
 * Legacy snapshots unpack to { version: 2, type: 'delta', ... } — they
 * have a numeric `version` field but no `v` field.
 * Encrypted envelopes have { v: 1, iv, ct, key_id }.
 */
 ...
 * Returns null if the binary is not an encrypted envelope.
 */
 ...
 * Returns an object with { encrypted: true, key_id, iv, ct } fields
 * to include in the to-device message content.
 */

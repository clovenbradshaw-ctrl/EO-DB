          ...
          <div style={{ position: 'relative' as const }}>
            ...
            {spaceOpen && (
              <div style={s.nulspaceDropdown}>
                ...
                <button
                  onClick={() => { setSelectedSpace(null); setSpaceOpen(false); setSelectedScope(null); setSelectedRecord(null); setShowMembers(false); }}
                ...
                {spaces.map((sp) => {
                  ...
                  return (
                    <button
                      key={sp.target}
                      onClick={() => { setSelectedSpace(sp.target); setSpaceOpen(false); setSelectedScope(null); setSelectedRecord(null); setShowMembers(false); }}
